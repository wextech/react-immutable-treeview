...
var _InsertIcon = require("../baseComponents/InsertIcon");

var _InsertIcon2 = _interopRequireDefault(_InsertIcon);

var _RemoveIcon = require("../baseComponents/RemoveIcon");
...
var ImmutableTree = function (_React$Component) {
    ...
    value: function eventFunctionFactory(onEventType) {
      return function (e, subNodePath, flag) {
        ...
        if (_immutable2.default.Iterable.isIndexed(this.props.data)) {
          ...
          if (onEventType !== 'onInsert' && onEventType !== 'onRemove') {
            nodePath = subNodePath.slice(2);
            if (nodePath.length !== 0) {
              nodePath = ["children"].concat(nodePath);
            }
          }
          // let tempNode = onEventType == 'onClick' ? flag === false ? null : nodePath : nodePath
  ...
  function ImmutableTree(props) {
    ...
    _this.onInsert = _this.eventFunctionFactory("onInsert").bind(_this);
    _this.onRemove = _this.eventFunctionFactory('onRemove').bind(_this);
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { style: { display: 'flex', marginBottom: '.5rem', justifyContent: 'space-between' } },
          _react2.default.createElement("input", { type: "text", placeholder: "\u8BF7\u8F93\u5165value" }),
          _react2.default.createElement("input", { type: "text", placeholder: "\u8BF7\u8F93\u5165key" }),
          _react2.default.createElement(_InsertIcon2.default, { lastNode: lastNode, onClick: this.onInsert }),
          _react2.default.createElement(_RemoveIcon2.default, { lastNode: lastNode, onClick: this.onRemove })
        ),
        _react2.default.createElement(_BaseImmutableTree2.default, {
          data: data,
          expanded: true,
          options: options,
