        ...
        props.data.map(function (nodeData, index) {
          return _react2.default.createElement(
            _TreeNode2.default,
            {
              ...
              expandButtonDisplay: nodeData.get("expandButtonDisplay") || props.options.expandButtonDisplay || nodeData.get("children") != null,
              expanded: nodeData.get("expanded") || undefined,
              onExpand: function onExpand(e) {
                return props.onExpand(e, [index], !nodeData.get("expanded"));
              },
              ...
              onCheck: function onCheck(e, checked) {
                return props.onCheck(e, [index], checked);
              }
            },
