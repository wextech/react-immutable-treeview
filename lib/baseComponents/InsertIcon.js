...
var InsertIcon = function (_React$Component) {
  _inherits(InsertIcon, _React$Component);

  function InsertIcon() {
    _classCallCheck(this, InsertIcon);

    return _possibleConstructorReturn(this, (InsertIcon.__proto__ || Object.getPrototypeOf(InsertIcon)).apply(this, arguments));
  }

  _createClass(InsertIcon, [{
    key: "render",
